      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 px-4 lg:grid-cols-2">
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-lg bg-base-100 p-5 shadow-sm">
            <h2 className="mb-5 text-xl font-bold">Product Description</h2>

            <div className="mb-4 grid grid-cols-2 border-b pb-3">
              <p>
                <span className="text-primary">Condition</span> :{" "}
                <span className="font-medium">{condition || "New"}</span>
              </p>

              <p>
                <span className="text-primary">Usage Time</span> :{" "}
                <span className="font-medium">{usage_time || "N/A"}</span>
              </p>
            </div>
        ...
        <div className="space-y-5">
          ...
          {/* SELLER */}
          <div className="rounded-lg bg-base-100 p-5 shadow-sm">
            <h2 className="mb-5 text-xl font-bold">Seller Information</h2>

            <div className="flex items-center gap-3">
              <div className="avatar placeholder">
                <div className="w-12 rounded-full bg-neutral text-neutral-content">
                  <span>{seller_name?.charAt(0) || "S"}</span>
                </div>
              </div>

              <div>
                <h3 className="font-bold">{seller_name || "Seller"}</h3>
